...
class Ant(object):
	...
	def set_node_path(self, ant_farm):
		self.node_path = []
		started = False
		self.node_path.append(ant_farm.start)
	...
	def set_location(self, pos, ant_farm):
			location = pos[ant_farm.start]
			self.current_location = location

	def set_journey(self, pos, num_steps, ant_farm):
		location_list = []
